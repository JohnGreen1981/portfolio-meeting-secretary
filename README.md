...
<p align="center">
  <img src="docs/screenshots/01-summary.png" width="45%" alt="Готовое саммари встречи: Кратко и Что решили" />
  <img src="docs/screenshots/02-tasks.png" width="45%" alt="Поручения с исполнителями и сроками" />
</p>
<p align="center">
  <img src="docs/screenshots/03-questions.png" width="45%" alt="Открытые вопросы и риски" />
  <img src="docs/screenshots/04-risks.png" width="45%" alt="Следующий шаг и .txt со стенограммой" />
</p>

Слева направо, сверху вниз: бот возвращает саммари с блоками «Кратко» и «Что решили», далее «Поручения» с исполнителями и сроками, «Открытые вопросы», и финальный шаг с прикреплённой стенограммой `.txt`.
